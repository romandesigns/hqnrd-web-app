...
export async function Gallery() {
  ...
  return (
    <article className="bg-muted/20 mx-auto grid h-86 w-full grid-cols-4 grid-rows-2 gap-2 overflow-hidden rounded-lg border border-gray-200 p-2 sm:h-120 lg:aspect-video lg:h-10/12 lg:max-w-7xl lg:gap-4 lg:p-4 dark:border-gray-800">
      {/* Left tall */}
